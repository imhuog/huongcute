...
class GameRoom {
    ...
    // Các method khác đã được di chuyển vào đây
...
} // <-- Dấu đóng ngoặc cuối cùng của lớp GameRoom đã được đặt đúng vị trí
...
}); // <--- Dấu đóng ngoặc và chấm phẩy đã được thêm vào đây.
